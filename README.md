...
1. Explain the difference between `RDBMS` and `SQL`.
  ...
  RDBMS is a relational database management system, it is used to manage relationships between sql tables

1. Why do tables need a `primary key`?

  To give each row a unique identity
...
1. What do we need in order to have a _many to many_ relationship between two tables.
  ...
  a third table that maps this relationship in a 1 to many way from each first table. 
